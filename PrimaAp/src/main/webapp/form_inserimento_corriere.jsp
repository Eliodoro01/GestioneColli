  ...
  <header id="header" class="header fixed-top" data-scrollto-offset="0">
    <div class="container-fluid d-flex align-items-center justify-content-between">
      ...
      <a href="home.jsp" class="logo d-flex align-items-center scrollto me-auto me-lg-0">
        ...
        <h1>Inserimento Corriere<span>.</span></h1>
      </a>
...
<div style="border:1px solid #0ea2bd" class="container" id = "formcorriere">
          ...
          <div class="col-lg-12">
					<c:if test="${corriere==null}">
						<form method="post" action="InserimentoCorriere" role="form">
					</c:if>

					<c:if test="${corriere!=null}">
						<form method="post" action="ModificaCorriere" role="form">
					</c:if>
              <div class="row">
              ...
              <c:if test="${corriere==null}">
	<button style="--bs-btn-bg :#0ea2bd !important ; --bs-btn-border-color :#0ea2bd !important" class="btn-primary btn" type="submit">Invia</button>
	<button style="--bs-btn-bg :#0ea2bd !important ; --bs-btn-border-color :#0ea2bd !important"class="btn-primary btn" type="reset">Reset</button>
	</c:if>

	<c:if test="${corriere!=null}">
	<input type="hidden" name="pold" value="${corriere.piva}">
	<input type="hidden" name="idaccount" value="${corriere.idaccount}">
	<button class="btn-primary btn" type="submit">Modifica</button>
	</c:if>
              </div>
            </form>
          </div><!-- End of Form -->
