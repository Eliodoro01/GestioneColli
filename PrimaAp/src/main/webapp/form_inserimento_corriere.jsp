  ...
  <header id="header" class="header fixed-top" data-scrollto-offset="0">
    <div class="container-fluid d-flex align-items-center justify-content-between">
      ...
      <a href="home.jsp" class="logo d-flex align-items-center scrollto me-auto me-lg-0">
        ...
        <h1>Gestione Colli<span>.</span></h1>
      </a>
...
<!-- Se non viene passato nessun corriere quando viene attivata questa pagina allora l'action sarà quella di inserire un corriere -->
...
<div class="container" id = "formcorriere">
